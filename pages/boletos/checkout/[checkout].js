            ...
            <div className='inferiorBox' style={{
              ...
              <div className='iframecontainer' style={{}} >
                <div className='iframe-header' style={{marginTop:'10px'}} >
                  <h1 style={{ fontWeight: '800', fontSize: '20px', lineHeight: '23px', marginTop: '113p', marginLeft: '50px', marginBottom: '23px' }}>Seleccione el método de pago </h1>{/* marginLeft: '-297px' */}
